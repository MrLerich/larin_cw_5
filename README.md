...
- Характеристика класса персонажа.
    ...
    * Подробнее предлагаемые классы можно посмотреть [***здесь](https://www.notion.so/5-ce3219e67b7b423197fd1b0b08011624).***
    ...
    * Подробнее предлагаемые умения можно посмотреть ***[здесь](https://www.notion.so/5-ce3219e67b7b423197fd1b0b08011624)***
...
Формула для расчета значения БРОНЯ_ЦЕЛИ приведена [ниже](https://www.notion.so/5-ce3219e67b7b423197fd1b0b08011624).
...
Вы можете воспользоваться [заготовленными](https://www.notion.so/5-ce3219e67b7b423197fd1b0b08011624) фразами для опубликования в блоке логов.
...
- **Этап 1. Разработка логики проекта**
    ...
    - Если выносливости недостаточно, возвращаем строку, что выносливости недостаточно ([ссылка](https://www.notion.so/5-ce3219e67b7b423197fd1b0b08011624)).
    ...
    Логика метода skill_effect() в конкретном классе должна соответствовать флоу проекта ([ссылка](https://www.notion.so/5-ce3219e67b7b423197fd1b0b08011624)).
    ...
    - Метод `get_armor_names`, который возвращает список с названиями брони.
        ...
        Методы «нанести удар» и «применить умение» должны возвращать строку в соответствии с флоу проекта (варианты можно посмотреть [здесь](https://www.notion.so/5-ce3219e67b7b423197fd1b0b08011624)).
